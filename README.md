# Registro de Actividades del Tratamiento de Datos — Marketing S.L.

![RGPD](https://img.shields.io/badge/RGPD-Compliance-1565C0?style=for-the-badge)
![GDPR](https://img.shields.io/badge/GDPR-Art.30-FF6B35?style=for-the-badge)
![Privacy](https://img.shields.io/badge/Protección-Datos-6A0DAD?style=for-the-badge)

> Registro de Actividades de Tratamiento (RAT) conforme al Art. 30 del RGPD para empresa de marketing digital.
...
| Archivo | Descripción |
|---|---|
| `*.pdf` | RAT completo en formato oficial |
| `Tablas.xlsx` | Inventario de tratamientos en hoja de cálculo |

## Contexto académico

**Asignatura:** Protección de Datos y Normativa Legal · **Institución:** Ingeniería Informática
